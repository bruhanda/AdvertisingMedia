...
class Widget {
    ...
    public function render() {
        ...
        /* Выводим виджет только в тех экшинах которые указаны в конфигурации */
        if ($widget_config != NULL) {


            if (in_array($action, $widget_config) or in_array($slug, $widget_config) or in_array('all_actions', $widget_config)) {
        ...
        /* В админ панели выводим все загруженные виджеты независимо от конфигурации */
